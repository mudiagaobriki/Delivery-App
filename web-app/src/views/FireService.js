...
export default function FireService() {
  ...
  const columns = [
    { title: "Location", field: 'name', cellStyle:isRTL ==='rtl'? {paddingRight:appcat === 'taxi'? 100: 180 , textAlign: 'right' }:{ paddingLeft: appcat === 'taxi'? 100: 180}, headerStyle:isRTL==='rtl'?{paddingRight: appcat === 'taxi'? 100: 180}:{ paddingLeft: appcat === 'taxi'? 100: 180}},
    { title: t('image'), field: 'image', cellStyle:{ textAlign: 'center'},render: rowData => <img alt='Car' src={rowData.image} style={{ width: 50 }}/>},
    { title: "Latitude", field: 'base_fare', type: 'numeric', cellStyle:{ textAlign: 'center'}},
    { title: "Longitude", field: 'rate_per_unit_distance', type: 'numeric', cellStyle:{ textAlign: 'center'}},
    { title: "Phone Number 1", field: 'rate_per_hour', type: 'numeric', cellStyle:{ textAlign: 'center'}},
    { title: "Phone Number 2", field: 'min_fare', type: 'numeric', cellStyle:{ textAlign: 'center'}},
    { title: "Phone Number 3", field: 'convenience_fees', type: 'numeric', cellStyle:{ textAlign: 'center'}},
    {
    ...
    { title: "Phone Number 5", field: 'extra_info' , cellStyle:{ textAlign:isRTL ==='rtl'? 'right' : 'left'}}
  ];
  ...
  // const fireservice = useSelector(state => state.fireservice);
  ...
  // console.log("State: ", cartypes.cars)
  useEffect(() => {
    if (cartypes.cars) {
